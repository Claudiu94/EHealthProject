package com.healthchart.springmvc.configuration;
...
@ComponentScan({ "com.healthchart.springmvc.dao" })
public class HibernateTestConfiguration {
	...
	public LocalSessionFactoryBean sessionFactory() {
		...
		sessionFactory.setPackagesToScan(new String[] { "com.healthchart.springmvc.model" });
